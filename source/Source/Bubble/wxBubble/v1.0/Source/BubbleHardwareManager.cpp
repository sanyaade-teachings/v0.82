                                                                        ...
                                                                        emptyDummyString(wxString(""))
{
    ...
    if (comboBoardName)
    {
        ...
        comboBoardName->append( "Maple Rev 3+ (to Flash)",
                                new wxImage(bubble->getLibPath() + wxString("/CPP/Targets/Maple.Rx.Arduino.v1.0/Images/Maple.Rx.Flash.Thumb.20110920a.png")));
        comboBoardName->append("Maple Rev 3+ (to RAM)",
                                new wxImage(bubble->getLibPath() + wxString("/CPP/Targets/Maple.Rx.Arduino.v1.0/Images/Maple.Rx.RAM.Thumb.20110920a.png")));
...
void BubbleHardwareManager::changeImage()
{
    ...
    else if (bubble->getBoardName() == wxString("Maple Rev 3+ (to Flash)"))
    {
        buttonMainImage->setImageDefault(wxImage(bubble->getLibPath() + wxString("/CPP/Targets/Maple.Rx.Arduino.v1.0/Images/Maple.Rx.Flash.20110906a.png")));
    }
    else if (bubble->getBoardName() == wxString("Maple Rev 3+ (to RAM)"))
    {
        buttonMainImage->setImageDefault(wxImage(bubble->getLibPath() + wxString("/CPP/Targets/Maple.Rx.Arduino.v1.0/Images/Maple.Rx.RAM.20110906a.png")));
    }
